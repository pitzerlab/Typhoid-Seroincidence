---
title: 'Estimating STRATAA Seroincidence: Nepal'
author: "Jo Walker"
date: "11/13/2024"
...
Data = read.csv(paste0(location,"Input Data/Nepal_Data.csv"))
...
census<-data.frame(
  ...
  pop = c(6054, 6766, 7569, 33380, 30954+17087)
)
...
```{r}
write.csv(MCMC.Estimates, paste0(location,"Output Data/Nepal_Estimates.csv"),row.names=F)

write.csv(dAll[["HlyE"]], paste0(location,"Output Data/HlyE_Responses_Nepal.csv"),row.names=F)
```

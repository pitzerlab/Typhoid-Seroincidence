---
title: 'Estimating STRATAA Seroincidence: Bangladesh'
author: "Jo Walker"
date: "11/12/2024"
...
Data = read.csv(paste0(location,"Input Data/Bangladesh_Data.csv"))
...
census<-data.frame(
  ...
  pop = c(10492, 10181, 10617, 36097, 43344)
)
...
```{r}
write.csv(MCMC.Estimates, paste0(location,"Output Data/Bangladesh_Estimates.csv"),row.names = F)

write.csv(dAll[["HlyE"]], paste0(location,"Output Data/HlyE_Responses_Bangladesh.csv"),row.names = F)
```
